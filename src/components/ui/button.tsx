  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-primary/20 bg-transparent hover:bg-primary-soft hover:border-primary/30",
        ...
        calm: "bg-gradient-calm text-white shadow-soft hover:shadow-glow hover:scale-[1.02]",
        premium: "bg-gradient-lavender text-white shadow-medium hover:shadow-glow hover:scale-[1.02] font-semibold",
        glass: "bg-white/10 backdrop-blur-md border border-white/20 text-foreground hover:bg-white/20",
        mood: "bg-gradient-ocean text-white shadow-soft hover:shadow-medium animate-pulse-soft",
        crisis: "bg-destructive text-white shadow-medium hover:shadow-glow animate-breathe font-semibold",
      },
      size: {
